...
function Education() {
    return (<>
        <div id="education" className="text-[#BDCAE5] flex flex-col md:flex-row justify-around h-full overflow-hidden">
            <div className="flex justify-center w-full p-10 md:w-1/2">
                <div className="flex flex-col pt-10 md:pt-28">
                    ...
                    <p className="mt-5 m-2 text-[#55D3D4]  md:text-bace md:font-semibold  text-justify ">Completed a Bachelor of Science in Information Technology from
                        ...
                        Certified in MERN Full Stack Development from Clever Academy, </p>
                </div>
            </div>
            <div className="flex flex-col justify-center w-full gap-6 p-10 mt-10 md:w-1/2">
                ...
                <div className="flex bg-[#122B3C] flex-col   p-1 font-semibold rounded-md py-2">
                    ...
                    <p className="text-[#55D3D4] px-10 md:text-bace md:font-semibold text-justify leading-6">@Error Make Clever-Acadmy</p>
                    <h2 className="text-[#55D3D4] text-base md:text-xl font-semibold px-10">Certification Holder </h2>
                </div>
            </div>
        </div>
        ...
        <div className="text-center">
            <h1 className=" text-xl font-bold text-white md:text-4xl">CERTIFICATION</h1>
        </div>
        <div className="w-full  flex justify-center pl-5 pr-5   md:pl-10 md:pr-10 ">

            <img src={ct} alt="sale" className="z-10 md:p-40 p-5 " />
        </div>
