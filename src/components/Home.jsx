            ...
            <div id="home" className="text-[#BDCAE5] flex flex-col md:flex-row justify-around h-full overflow-hidden">
                <div className="w-full md:w-1/2 flex justify-center">
                    <div className="flex flex-col pt-10 md:pt-40">
                        ...
                        <p className="mt-5 m-2 text-[#55D3D4]  md:text-bace md:font-semibold animate-slide-from-top">"I build dynamic and scalable web applications using the  <br /> MERN stack,crafting seamless user experiences with <br />   cutting-edge technologies" </p>
                    </div>
                </div>
